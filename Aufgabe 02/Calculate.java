/* 
 * Erstellen Sie ein Programm in der öffentlichen Klasse Calculate. Legen Sie darin zwei Konstanten mit dem Datentypen double für eine Spannung (VOLTAGE) und eine Stromstärke (CURRENT) an. 
 * Initialisieren Sie die Konstanten mit den unten angegebenen Werten. Legen Sie eine weitere Variable pwr mit dem Datentypen float an und speichern Sie darin die resultierende Leistung (Produkt aus VOLTAGE und CURRENT).
...
public class Calculate {
    public static void main(String[] args) {
        ...
        final double VOLTAGE = 223.0;
        final double CURRENT = 9.1;

        // Variable für Leistung
